...
postgresql_env_vars=(
    ...
    POSTGRESQL_LDAP_BIND_USE_PASSFILE
...
export POSTGRESQL_REPLICATION_USE_PASSFILE="${POSTGRESQL_REPLICATION_USE_PASSFILE:-yes}"
...
export POSTGRESQL_LDAP_BIND_USE_PASSFILE="${POSTGRESQL_LDAP_BIND_USE_PASSFILE:-yes}"
export POSTGRESQL_LDAP_BIND_PASSFILE_PATH="${POSTGRESQL_LDAP_BIND_PASSFILE_PATH:-${POSTGRESQL_CONF_DIR}/.ldap_bindpass}"
...
export REPMGR_SSH_OPTIONS="${REPMGR_SSH_OPTIONS:--o StrictHostKeyChecking=accept-new}"
...
export REPMGR_USE_PASSFILE="${REPMGR_USE_PASSFILE:-yes}"
export REPMGR_PASSFILE_PATH="${REPMGR_PASSFILE_PATH:-$REPMGR_CONF_DIR/.pgpass}"
export REPMGR_SSL_MODE="${REPMGR_SSL_MODE:-prefer}"
export REPMGR_SSL_CA_FILE="${REPMGR_SSL_CA_FILE:-}"
