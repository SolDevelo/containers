...
rabbitmq_env_vars=(
    ...
    RABBITMQ_COMMUNITY_PLUGINS_SECURE
    RABBITMQ_USERNAME
    RABBITMQ_PASSWORD
    RABBITMQ_FORCE_BOOT
...
export RABBITMQ_COMMUNITY_PLUGINS="${RABBITMQ_COMMUNITY_PLUGINS:-}"
export RABBITMQ_COMMUNITY_PLUGINS_SECURE="${RABBITMQ_COMMUNITY_PLUGINS_SECURE:-yes}"
