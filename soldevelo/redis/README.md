...
```console
curl -sSL https://raw.githubusercontent.com/soldevelo/containers/main/soldevelo/redis/8.8/debian-12/docker-compose.yml > docker-compose.yml
docker compose up -d
```
...
cd containers/soldevelo/redis/8.8/debian-12
