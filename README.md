...
| **RabbitMQ** — Open-source message broker implementing AMQP | [![Docker Hub](https://img.shields.io/docker/v/soldevelo/rabbitmq?sort=semver&label=soldevelo%2Frabbitmq)](https://hub.docker.com/r/soldevelo/rabbitmq/tags) |
| **Prometheus** — Systems monitoring and alerting toolkit with PromQL | [![Docker Hub](https://img.shields.io/docker/v/soldevelo/prometheus?sort=semver&label=soldevelo%2Fprometheus)](https://hub.docker.com/r/soldevelo/prometheus/tags) |
| **Apache ZooKeeper** — Centralised service for distributed configuration and coordination | [![Docker Hub](https://img.shields.io/docker/v/soldevelo/zookeeper?sort=semver&label=soldevelo%2Fzookeeper)](https://hub.docker.com/r/soldevelo/zookeeper/tags) |
